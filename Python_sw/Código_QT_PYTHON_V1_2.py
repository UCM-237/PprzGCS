...
try:
    ...
    Estrategia = pd.read_csv('~/PprzGCS/datos.txt', delimiter=':', header = None) #Datos.txt
    ...
    if Mapa == " Sin Mapa":
      ...
      #  print("SIN MAPAA")
        ...
        tree = ET.parse(f'~/paparazzi/conf/flight_plans/UCM/{Archivo}.xml')
        root = tree.getroot()
        ...
        xml_file = f'~/paparazzi/conf/flight_plans/UCM/{Archivo}.xml'
        dtd_file = '~/paparazzi/conf/flight_plans/flight_plan.dtd'
        ...
        with open(f'~/paparazzi/conf/flight_plans/UCM/{Archivo}_opt.xml', 'w', encoding='utf-8') as f:
       ...
       # print("Waypoints reescritos y guardados")
        ...
        tree = ET.parse(f'~/paparazzi/conf/airframes/UCM/{Controlador}.xml')
        root = tree.getroot()
        ...
        tree = ET.parse('~/paparazzi/conf/airframes/UCM/conf.xml')
        root = tree.getroot()
        ...
        # Guardar los cambios en el archivo XML
        output_path_comp = '~/paparazzi/conf/airframes/UCM/conf.xml'
