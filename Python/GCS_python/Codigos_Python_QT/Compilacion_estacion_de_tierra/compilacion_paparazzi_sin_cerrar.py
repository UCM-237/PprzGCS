...
# Compilar el airframe y el flight plan sin cerrar Paparazzi
compilation = subprocess.run(["make", f"AIRCRAFT={AIRFRAME}"])

# Verificar si la compilación fue exitosa
if compilation.returncode == 0:
    print("Compilación exitosa. Ve a Paparazzi GCS y actualiza el flight plan manualmente.")
else:
